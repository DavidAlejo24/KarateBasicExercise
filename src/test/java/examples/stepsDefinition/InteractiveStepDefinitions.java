package examples.stepsDefinition;


import examples.tasks.NavegationAPI;
...
public class InteractiveStepDefinitions {

    @Before
    public void setTheStage() {
        OnStage.setTheStage(new OnlineCast());
    }
    @Given("{actor} create a json structure")
    public void accede_al_sistema(Actor actor) throws IOException, ParseException {
        //NavegationAPI.createJSON();
        actor.wasAbleTo(NavegationAPI.createJSON());
    }
/*
    @Before
    public void setTheStage() {
